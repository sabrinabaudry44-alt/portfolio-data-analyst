<p align="center">
  <img src="./00_profil/image/logo-data-analyst.png" alt="Logo Data Analyst" width="300">
</p>
...
![Logo Data Analyst](./00_profil/image/logo-data-analyst.png)
...
À travers mes différents projets, j'ai développé une approche structurée allant de la collecte et du nettoyage des données jusqu'à l'analyse exploratoire, la visualisation et la mise en place de modèles de Machine Learning.
...
### Analyse et traitement de données éducatives

Projet réalisé autour de la préparation, de l'analyse et de la structuration de données.

**Technologies :**

`Python` `Pandas` `Analyse de données` `Tests` `Reporting`

👉 [Voir le projet](./Projets/01_EduStat/)

---

## 02 — Voltéo Énergies

### Collecte, nettoyage et analyse de données énergétiques

Projet consacré à la collecte, au nettoyage et à la préparation de données de production énergétique.
...
### Diagnostic et analyse exploratoire de données internationales

Projet d'analyse de données comprenant le nettoyage, l'analyse exploratoire, la visualisation et l'utilisation de SQL.

**Technologies :**

`Python` `Pandas` `SQL` `Data Visualization` `Jupyter`

👉 [Voir le projet](./Projets/03_numéris_conseil/)

---

## 04 — Sécurité alimentaire — FAO

### Analyse des données liées à la sécurité alimentaire
...
👉 [Voir le projet](./Projets/04_FAO_sécurité_alimentaire/)
